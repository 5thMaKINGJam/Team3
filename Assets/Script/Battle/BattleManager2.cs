...
public class BattleManager2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        throwButton.onClick.AddListener(() => Attack("바람", throwEffect));
        kickButton.onClick.AddListener(() => Attack("묶기", kickEffect));
        punchButton.onClick.AddListener(() => Attack("번개", punchEffect));
    }
    ...
    IEnumerator ReturnToPreviousScene()
    {
        ...
        SceneManager.LoadScene("10"); // 이전 씬 로드
    }
